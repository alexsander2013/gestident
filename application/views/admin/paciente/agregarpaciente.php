                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <input name="distrito" class="form-controls input-sm1" value='1' type="hidden" disabled>
             ...
             <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="dni" class="form-control input-sm" placeholder="Documento" maxlength="18" minlength="18" onKeyPress="if (event.keyCode < 48 || event.keyCode > 57)event.returnValue = false;">
                    </div>
                  </div>
              </div>
