                        ...
                        <div class="modal-content">
                                             ...
                                             <div class="modal-body">
                                                    ...
                                                    <select class="form-control input-sm select" name="tipo_documento" >
                                                     ...
                                                     <option value="2" <?php echo set_value('tipo_documento',$usuario->tipo_documento)==2 ? "selected" : "" ?>>T.I</option>
                                                     <option value="3" <?php echo set_value('tipo_documento',$usuario->tipo_documento)==3 ? "selected" : "" ?>>PASAPORTE</option>
                                                     <option value="4" <?php echo set_value('tipo_documento',$usuario->tipo_documento)==4 ? "selected" : "" ?>>NIT</option>
